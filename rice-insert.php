<?php
    ...
    // product all
    $query = mysqli_query($conn, "SELECT * FROM rice");
...
if(!empty($_GET['Product_id'])) {
    $query_rice = mysqli_query($conn, "SELECT * FROM rice WHERE Product_id='{$_GET['Product_id']}'");
    $row_rice = mysqli_num_rows($query_rice);

    if($row_product == 0) {
        header('location:' . $base_url . '/rice-insert.php');
    }

    $result = mysqli_fetch_assoc($query_rice);
}
    ...
    <div class="container" style="margin-top: 30px;">
        ...
        <div class="row g-5">
            <div class="col-md-8 col-sm-12">
                <form action="<?php echo $base_url; ?>/rice-form.php" method="post" enctype="multipart/form-data">
