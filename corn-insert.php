<?php
    ...
    // product all
    $query = mysqli_query($conn, "SELECT * FROM corn");
...
if(!empty($_GET['Product_id'])) {
    $query_durian = mysqli_query($conn, "SELECT * FROM corn WHERE Product_id='{$_GET['Product_id']}'");
    ...
    <div class="container" style="margin-top: 30px;">
        ...
        <div class="row g-5">
            <div class="col-md-8 col-sm-12">
                <form action="<?php echo $base_url; ?>/corn-form.php" method="post" enctype="multipart/form-data">
