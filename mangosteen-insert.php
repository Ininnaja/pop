<?php
    ...
    // product all
    $query = mysqli_query($conn, "SELECT * FROM mangosteen");
...
if(!empty($_GET['Product_id'])) {
    $query_mangosteen = mysqli_query($conn, "SELECT * FROM mangosteen WHERE Product_id='{$_GET['Product_id']}'");
    $row_mangosteen = mysqli_num_rows($query_mangosteen);

    if($row_product == 0) {
        header('location:' . $base_url . '/mangosteen-insert.php');
    }

    $result = mysqli_fetch_assoc($query_mangosteen);
}
    ...
    <div class="container" style="margin-top: 30px;">
        ...
        <div class="row g-5">
            <div class="col-md-8 col-sm-12">
                <form action="<?php echo $base_url; ?>/mangosteen-form.php" method="post" enctype="multipart/form-data">
