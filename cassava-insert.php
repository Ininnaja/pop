<?php
    ...
    // product all
    $query = mysqli_query($conn, "SELECT * FROM cassava");
...
if(!empty($_GET['Product_id'])) {
    $query_cassava = mysqli_query($conn, "SELECT * FROM cassava WHERE Product_id='{$_GET['Product_id']}'");
    $row_cassava = mysqli_num_rows($query_cassava);

    if($row_product == 0) {
        header('location:' . $base_url . '/cassava-insert.php');
    }

    $result = mysqli_fetch_assoc($query_cassava);
}
    ...
    <div class="container" style="margin-top: 30px;">
        ...
        <div class="row g-5">
            <div class="col-md-8 col-sm-12">
                <form action="<?php echo $base_url; ?>/cassava-form.php" method="post" enctype="multipart/form-data">
