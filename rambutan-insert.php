<?php
    ...
    // product all
    $query = mysqli_query($conn, "SELECT * FROM rambutan");
...
if(!empty($_GET['Product_id'])) {
    $query_rambutan = mysqli_query($conn, "SELECT * FROM rambutan WHERE Product_id='{$_GET['Product_id']}'");
    $row_rambutan = mysqli_num_rows($query_rambutan);

    if($row_product == 0) {
        header('location:' . $base_url . '/rambutan-insert.php');
    }

    $result = mysqli_fetch_assoc($query_rambutan);
}
    ...
    <div class="container" style="margin-top: 30px;">
        ...
        <div class="row g-5">
            <div class="col-md-8 col-sm-12">
                <form action="<?php echo $base_url; ?>/rambutan-form.php" method="post" enctype="multipart/form-data">
