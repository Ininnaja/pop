...
<body>
    ...
    <div class="container">
        <div class="intro-Product">
            <div class="name-item">
                <p style="font-size: 42px;">มังคุด</p>
            </div>
        </div>
        <div class="city-product">
            <div class="city-item">
                <p style="font-size: 28px;">จังหวัดเด่นๆที่รับซื้อ</p>
                <p style="font-size: 24px;">สุราษฎร์ธานี นครศรีธรรมราช</p>
            </div>
        </div>
        <div class="imgand-price">
            <div class="img-Product">
                <img class="product-img" src="./assets/q1.png"/>
            </div>
    ...
    <div class="container">
        ...
        <div class="img-graph">
            <img class="graph-img" src="./assets/g-q.png"/>
        </div>
        <div class="intro-Product">
