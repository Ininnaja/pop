...
<body>
    ...
    <div class="container">
        <div class="intro-Product">
            <div class="name-item">
                <p style="font-size: 42px;">ทุเรียน</p>
            </div>
        </div>
        <div class="city-product">
            <div class="city-item">
                <p style="font-size: 28px;">จังหวัดเด่นๆที่รับซื้อ</p>
                <p style="font-size: 24px;">สุราษฎร์ธานี  ชุมพร  จันทบุรี</p>
            </div>
        </div>
        <div class="imgand-price">
            <div class="img-Product">
                <img class="product-img" src="./assets/rectangle-8.png"/>
            </div>
            <div class="price-Product">
                <div class="price1">
                    <p style="font-size: 24px;">ราคา</p>
                    <p style="font-size: 54px;" >150</p>
                    <p style="font-size: 24px;">บาท/กก.</p>
                </div>
                <div class="price2">
                    <p style="font-size: 24px;">วันที่</p>
                    <p style="font-size: 32px;">24 ก.ย. 66</p>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="img-graph">
            <img class="graph-img" src="./assets/graph du.png"/>
        </div>
        <div class="intro-Product">
