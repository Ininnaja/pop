<?php
    ...
    // product all
    $query = mysqli_query($conn, "SELECT * FROM palm");
...
if(!empty($_GET['Product_id'])) {
    $query_palm = mysqli_query($conn, "SELECT * FROM palm WHERE Product_id='{$_GET['Product_id']}'");
    $row_palm = mysqli_num_rows($query_palm);

    if($row_product == 0) {
        header('location:' . $base_url . '/palm-insert.php');
    }

    $result = mysqli_fetch_assoc($query_palm);
}
    ...
    <div class="container" style="margin-top: 30px;">
        ...
        <div class="row g-5">
            <div class="col-md-8 col-sm-12">
                <form action="<?php echo $base_url; ?>/palm-form.php" method="post" enctype="multipart/form-data">
