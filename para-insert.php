<?php
    ...
    // product all
    $query = mysqli_query($conn, "SELECT * FROM para");
...
if(!empty($_GET['Product_id'])) {
    $query_para = mysqli_query($conn, "SELECT * FROM para WHERE Product_id='{$_GET['Product_id']}'");
    $row_para = mysqli_num_rows($query_para);

    if($row_product == 0) {
        header('location:' . $base_url . '/para-insert.php');
    }

    $result = mysqli_fetch_assoc($query_para);
}
    ...
    <div class="container" style="margin-top: 30px;">
        ...
        <div class="row g-5">
            <div class="col-md-8 col-sm-12">
                <form action="<?php echo $base_url; ?>/para-form.php" method="post" enctype="multipart/form-data">
