...
<body>
    ...
    <div class="container">
        <div class="intro-Product">
            <div class="name-item">
                <p style="font-size: 42px;">ยางพารา</p>
            </div>
        </div>
        <div class="city-product">
            <div class="city-item">
                <p style="font-size: 28px;">จังหวัดเด่นๆที่รับซื้อ</p>
                <p style="font-size: 24px;">นครศรีธรรมราช สุราษฎร์ธานี  ระยอง</p>
            </div>
        </div>
        <div class="imgand-price">
            <div class="img-Product">
                <img class="product-img" src="./assets/ยางพารา.png"/>
            </div>
            <div class="price-Product">
                <div class="price1">
                    <p style="font-size: 32px;">ราคา</p>
                    <?php 
                        $sql = "SELECT Price as Price FROM para";
                ...
                <div class="price2">
                    ...
                    <?php 
                        $sql = "SELECT Date as Date FROM para";
                        $query = $conn->prepare($sql);
                        $query->execute();
                        $fetch = $query->fetch();
                    ?>
    ...
    <div class="container">
        ...
        <div class="img-graph">
            <img class="graph-img" src="./assets/กราฟยาง.png"/>
        </div>
        <div class="intro-Product">
